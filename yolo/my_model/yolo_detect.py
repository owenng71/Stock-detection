...
while True:
    ...
    cv2.putText(frame, f'Total objects: {object_count}', (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
    
    # Display count of each class
    y_offset = 60
    for classname, count in class_counts.items():
        cv2.putText(frame, f'{classname}: {count}', (10, y_offset), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
        y_offset += 20
    ...
    # If inferencing on individual images, wait for user keypress before moving to next image. Otherwise, wait 5ms.
